...
public class App {
    public static void main(String[] args) {
        ...
        int exp = 2;
        String word = "civic";
        double test = 34532765.5244843;
        System.out.printf("Number format test %,.2f \n", test);

        // arrayRunner(arr);
        // intRunner(arr, missingNumArr);
        // stringRunner(word);
        recursionRunner(arr, n, base, exp);
    }
        
    static void arrayRunner(int[] arr) {
    ...
    static void intRunner(int[] arr, int[] missingNumArr) {
    ...
    static void stringRunner(String word) {
        System.out.printf("Is '%s' a plaindrome? %s", word, StringWork.isPalindrome(word));
        System.out.println("");
    }

    static void recursionRunner(int[] arr, int n, int base, int exp){
